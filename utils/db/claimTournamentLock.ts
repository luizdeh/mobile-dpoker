...
// that's how we detect "someone else has this tournament open" without a race.
export const claimTournamentLock = async (tournamentId: number, deviceId: string) => {
  try {
    ...
    console.log("[ERROR] claimTournamentLock() =>", error.message);
    return null;
  }
};
